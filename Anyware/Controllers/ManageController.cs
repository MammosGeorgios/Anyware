...
namespace Anyware.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //vazw kai to context gia na exw prosvasi sta dika mou fields ston user
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var user = db.Users.SingleOrDefault(x => x.Id == userId); // giata extra dedomena
